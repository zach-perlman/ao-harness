"""One-off: 4-quadrant eval comparison of AO v3 vs AO v3 + KL reg."""
...
MODELS = {
    "500k_pl_31k_spqav2_199k_sqav3_126k_cls": "AO v2.1",
    "500k_pl_31k_spqav2_199k_sqav3_126k_cls_100k_chatreg": "AO v2.1 + KL",
}
...
def main():
    ...
    for rd in result_dirs:
        ...
        for eval_name, json_files in eval_jsons.items():
            for jf in json_files:
                ...
                # Collect all metric keys we need for this eval
                needed = set()
                for group in GROUPS:
    ...
    plt.suptitle("Chat Regularization Comparison — AO v2.1 vs AO v2.1 + KL",
                 fontsize=FONT_SUPTITLE, fontweight="bold", y=0.98)
    plt.tight_layout(rect=[0, 0.04, 1, 0.96])

    os.makedirs("experiments/eval_plots", exist_ok=True)
    out = "experiments/eval_plots/chatreg_comparison.png"
